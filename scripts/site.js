...
//  });
  ...
  $(".nd-testimonials-one").click(function(event) {
   ...
   var testim = $(this).parents(".nd-testimonials").find('.chosen-testim');
    ...
    var datahtml = '<iframe src=&quot;https://player.vimeo.com/video/331681665?byline=0&portrait=0&title=0&autoplay=1&quot; allowfullscreen allow=&quot;autoplay; fullscreen&quot; scrolling=&quot;no&quot;></iframe>';
